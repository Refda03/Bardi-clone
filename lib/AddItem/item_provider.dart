...
class EmployeeProvider extends ChangeNotifier {
  ...
  Future<List<EmployeeModel>> getEmployee() async {
    var url = Uri.parse('http://employee-crud-flutter.daengweb.id/index.php');
  ...
  Future<bool> storeEmployee(String name, String salary, String age) async {
    var url = Uri.parse('http://employee-crud-flutter.daengweb.id/add.php');
  ...
  Future<bool> updateEmployee(id, name, salary, age) async {
    var url = Uri.parse('http://employee-crud-flutter.daengweb.id/update.php');
    final response = await http.post(url, body: {
      'id': id,
      'employee_name': name,
      'employee_salary': salary,
  ...
  Future<void> deleteEmployee(String id) async {
    await http.get(Uri.parse('http://employee-crud-flutter.daengweb.id/delete.php'+id));
  }
}